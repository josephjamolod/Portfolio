...
export default function About() {
  return (
    <section className="flex flex-col h-screen bg-gray-300">
      <div className="bg-red-400 h-full flex-1">red</div>
    ...
    //     whileInView={"show"}
    //     id="techStack"
    //     className="flex flex-col items-center flex-1 px-5 md:px-0 md:pr-10 justify-center mt-10 md:mt-0 "
    //   >
    //     <TechStack />
    //   </motion.div>
    // </section>
