  ...
  return (
    ...
    >
      <div className="flex flex-col flex-1 px-5 items-center text-center md:items-start md:text-start md:pl-20 md:pr-0 xl:pl-40 2xl:pl-60 ">
        ...
        <h1 className="font-bold text-6xl lg:text-8xl">Joseph</h1>
        <p className=" my-5 font-semibold max-w-80 text-base pt-5">
        ...
        <Link
          to="/projects"
          className="text-white mt-5  px-5 bg-gray-900 min-h-10 md:min-h-14 flex items-center justify-center gap-2 hover:bg-white  hover:border hover:border-gray-900 hover:text-gray-900 transition duration-300"
        >
          See Projects
          <MdOutlineKeyboardDoubleArrowRight className="text-2xl" />
        </Link>
      </div>
      <div className="flex flex-1 px-5 md:px-0 justify-center 2xl:justify-start 2xl:flex-auto 2xl:pl-32">
